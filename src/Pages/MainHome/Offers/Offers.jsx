  ...
  return (
    <div className='pt-[80px] container font-secondry'>
        <div className="flex items-center justify-between">
            <h1 className='text-dark text-[40px] tracking-wider font-bold'>Offers</h1>
            <button className='bg-blue text-white rounded-md px-6 py-2 hover:bg-blue2 transition-all duration-300'>View All</button>
        </div>
        <div className="grid grid-cols-4 gap-16 mt-[30px] font-primary border-b border-offWhite pb-[80px]">
